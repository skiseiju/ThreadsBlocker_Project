...
| 2.5.0 | 定點絕多貼文排程、冷卻倒數、Worker 喚醒改用 replaceState+reload、安全性修復 |
| 2.5.1 | 修復定點絕 standby 旗標殘留導致無法啟動；冷卻倒數改用時間戳避免背景節流；多語系擴充至 20 國（繁中/簡中/英/日/韓/泰/印尼/西/法/德/義/葡/俄/波蘭/土耳其/越南/阿拉伯/印地/荷蘭/菲律賓），worker.js + core.js 硬寫選擇器全部改用 CONFIG 常數 |
