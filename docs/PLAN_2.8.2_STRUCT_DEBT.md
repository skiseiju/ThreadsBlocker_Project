...
| 27 | 未定 | 線上回報 #50／#51／#52（2026-08-05 至 08-06，2.8.2） | 三無掃描粉絲超過約兩千人就卡死：掃描視窗自行關閉、每掃一次跳一次個人頁、記憶體用盡到需強迫關機、停止並保留進度按了畫面不回來 | 大 | 未動工，見下方第 27 節。**旁證**：疑似機制之一（勾選框寫入風暴）`2.8.3-beta6` 已修；另一疑似機制（結算撞 localStorage 配額無聲卡死）`2.8.4-beta22`（ADR 0023）已修。等回報者（hwid 681ade52）升級後回報即可定案 |
