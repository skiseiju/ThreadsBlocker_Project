export const CONFIG = {
    ...
    PLATFORM_SYNC_CONSENT_POLICY_VERSION: 'platform-sync-v2',
    ...
    KEYS: {
        ...
        THREE_NO_LAST_SCAN_DATE: 'hege_three_no_last_scan_date',
        ...
        THREE_NO_UNREAD_COUNT: 'hege_three_no_unread_count',
        THREE_NO_IGNORED_USERS: 'hege_three_no_ignored_users',
        ...
        THREE_NO_AUTO_BLOCK: 'hege_three_no_auto_block',
        POS: 'hege_panel_pos',
        ...
        PLATFORM_SOURCE_CREATED_AT: 'hege_platform_source_created_at',
        PLATFORM_SOURCE_FIRST_VERSION: 'hege_platform_source_first_version',
        PLATFORM_UPLOAD_STATS: 'hege_platform_upload_stats',
        PLATFORM_REUPLOAD_REPAIR_V1_DONE: 'hege_platform_reupload_repair_v1_done',
        PLATFORM_REUPLOAD_REPAIR_V1_AT: 'hege_platform_reupload_repair_v1_at',
    ...
    SYNC_KEYS: [
        ...
        'hege_three_no_auto_block', // THREE_NO_AUTO_BLOCK
    ],
