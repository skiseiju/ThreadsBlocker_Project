export const CONFIG = {
  ...
  BUG_REPORT_URL:
    "https://threadsblocker-bug-admin.skiseiju.workers.dev/api/v1/reports/bug",
  ...
  PLATFORM_UPLOAD_URL:
    "https://threadsblocker-bug-admin.skiseiju.workers.dev/api/v1/platform/ingest",
